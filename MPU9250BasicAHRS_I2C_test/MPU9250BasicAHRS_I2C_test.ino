...
void setup()
{
  ...
  if (c == 0x76) // WHO_AM_I should always be 0x71
  {
...
void loop()
{
  ...
  //OVER HERE I CHANGED HERE LOOK HERER SL DN SMKDMSP"M PDMSLDN NSO:FDNOSNOD NOSDOS DOSLJKFD
...
//    MahonyQuaternionUpdate(myIMU.ax, myIMU.ay, myIMU.az, myIMU.gx * DEG_TO_RAD,
//                         myIMU.gy * DEG_TO_RAD, myIMU.gz * DEG_TO_RAD, myIMU.deltat);
