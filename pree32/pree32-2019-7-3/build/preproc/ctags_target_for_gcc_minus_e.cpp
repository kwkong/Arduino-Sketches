# 1 "c:\\Arduino\\My Sketches\\pree32-2019-7-3\\pree32-2019-7-3.ino"
# 1 "c:\\Arduino\\My Sketches\\pree32-2019-7-3\\pree32-2019-7-3.ino"
# 2 "c:\\Arduino\\My Sketches\\pree32-2019-7-3\\pree32-2019-7-3.ino" 2

# 4 "c:\\Arduino\\My Sketches\\pree32-2019-7-3\\pree32-2019-7-3.ino" 2

# 6 "c:\\Arduino\\My Sketches\\pree32-2019-7-3\\pree32-2019-7-3.ino" 2

# 8 "c:\\Arduino\\My Sketches\\pree32-2019-7-3\\pree32-2019-7-3.ino" 2
...
int counter[1200]; //prev 400
int currents[1200]; //prev 200
int voltages[1200]; //prev 200
...
void swPollCheck()
{
    if (digitalRead(27) == 0)
    {
        ...
        digitalWrite(25, !digitalRead(25)); //toggle
        digitalWrite(12, digitalRead(25));
...
void preeTestMode()
{
    ...
    while (1)
    {
        digitalWrite(12, !digitalRead(12)); //toggle sLED for feedback on loop
...
void getVals() {
    ...
    while (count1 < 1200) //was <=
    {
        voltages[count1] = analogRead(35);
        currents[count1] = analogRead(34);
