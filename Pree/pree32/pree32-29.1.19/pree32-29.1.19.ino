...
void preeTestMode()
{
	...
	while(1)
	{
      ...
      if(inStringMatch("clear"))
		...
		if(testModeMode == 2)    //shows avg ipp and voltage reading
		{
			int avgRaw = 0;
			float avgCal = 0;
			int i = 0;
...
boolean inStringMatch(String msg)		//appends argument string with NL and CR, and returns true if string match
{
	...
	if(inputString.equalsIgnoreCase(msg)) //<################################################################## this line
	matchBool = true;
