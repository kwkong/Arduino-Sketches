# 1 "c:\\Arduino\\My Sketches\\pree32CT-2019-11-5\\pree32CT-2019-11-5.ino"
# 1 "c:\\Arduino\\My Sketches\\pree32CT-2019-11-5\\pree32CT-2019-11-5.ino"
# 2 "c:\\Arduino\\My Sketches\\pree32CT-2019-11-5\\pree32CT-2019-11-5.ino" 2

# 4 "c:\\Arduino\\My Sketches\\pree32CT-2019-11-5\\pree32CT-2019-11-5.ino" 2

# 6 "c:\\Arduino\\My Sketches\\pree32CT-2019-11-5\\pree32CT-2019-11-5.ino" 2

# 8 "c:\\Arduino\\My Sketches\\pree32CT-2019-11-5\\pree32CT-2019-11-5.ino" 2
...
float voltageRMS = 115.0;
            ...
            float ipps[5]; //new variables 2019/8/2
            int ippCount = 0;
            float ippAvg = 0;
            float ippAvgOld = 0;
...
void setup()
{
    ...
    pinMode(25, 0x02);
    pinMode(12 /*default is 14*/, 0x02);
    pinMode(14 /*default is 12*/, 0x02);
    pinMode(26, 0x05);
    pinMode(27, 0x05);

    bool TEST = false;

    digitalWrite(14 /*default is 12*/, 0x1);
    delay(3000);
    digitalWrite(14 /*default is 12*/, 0x0);
    ...
    {
        TEST = true;
        digitalWrite(12 /*default is 14*/, 0x1);
        digitalWrite(14 /*default is 12*/, 0x1);
    }

    digitalWrite(12 /*default is 14*/, 0x0);
    digitalWrite(14 /*default is 12*/, 0x0);
...
void swPollCheck()
{
    if (digitalRead(27) == 0)
    {
        ...
        digitalWrite(12 /*default is 14*/, digitalRead(25));
...
void preeTestMode()
{
    ...
    while (1)
    {
        digitalWrite(12 /*default is 14*/, !digitalRead(12 /*default is 14*/)); //toggle sLED for feedback on loop
